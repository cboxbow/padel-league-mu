...
const translations = {
  fr: {
    nav: {
      ...
      clubs: 'Clubs', calendar: 'Calendrier', rankings: 'Classements', results: 'Résultats', gallery: 'Galerie', admin: 'Admin',
    },
    hero: {
  ...
  en: {
    nav: {
      ...
      clubs: 'Clubs', calendar: 'Calendar', rankings: 'Rankings', results: 'Results', gallery: 'Gallery', admin: 'Admin',
    },
    hero: {
