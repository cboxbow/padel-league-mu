...
const PLAYER_NAME_ALIASES = new Map([
  ...
  // Ajouts (audit player_id, 2026-09-02) : joueurs classes dont le nom
  // saisi dans les resultats ne correspondait pas exactement (nom complet,
  // ordre prenom/nom, accents, surnom) au format stocke dans public.players.
  // Verifie individuellement contre la table players avant ajout -- cas
  // ambigus (nom de famille partage mais prenom different, ex. fratrie)
  // volontairement exclus pour ne pas mal attribuer les points de quelqu'un.
  ['AARON SANCHEZ', 'AARON SANCHEZ ROMERO'],
  ['MICKAEL GOSCH', 'MICKAEL JORGE GOSCH'],
  ['OLIVIER DESVAUX', 'OLIVIER DESVAUX DE MARIGNY'],
  ['JULES DE SPEVILLE', 'DOGER DE SPEVILLE JULES'],
  ['LANDRY RABEZAFY', 'MAMITIANA LANDRY RABEZAFY'],
  ['SEBASTIEN NG CHEONG TIN', 'JEAN SEBASTIEN NG CHEONG TIN'],
  ['ALVIN TSE', 'ALVIN TSE CHI SHUM'],
  ['ALAIN LANGLOIS', 'PIERRE ALAIN LANGLOIS'],
  ['KUNAL SEWNAUTH', 'SURENDRA KUNAL SEWNAUTH'],
  ['YANNICK YEW', 'YANNICK YEW HIN'],
  ['YANNICK DE MEZIERES', 'YANNICK DE MEZIERES LEPERVANCHE'],
  ['ZAID JEEWON', 'ZAID MUHAMMAD JEEWON'],
  ['DICK JIA', 'DICK JIA YOUNG CHING'],
  ['AMAURY A R DESVAUX', 'A R AMAURY DESVAUX DE MARIGNY'],
  ['TONY KONG', 'TONY KONG TIN LUN'],
  ['JONATHAN MATHIEU', 'JONATHAN E MATHIEU'],
  ['SANDRINE DE SPEVILLE', 'SANDRINE DOGER DE SPEVILLE'],
  ['WESLEY WATSON', 'WESLEY HOWARD WATSON'],
  ['TIMOTHY LEE', 'TIMOTHY LEE TIN CHIN'],
  ['THOMAS D', 'D UNIENVILLE THOMAS'],
  ['PAMELA JUGDARREE', 'PAMELA PAQUITA JUGDARREE'],
  ['DAMIEN PUTTEEA', 'GREGORI DAMIEN PUTTEEA'],
  ['THIERRY VELVENDRON', 'THIERRY CLOVIS PASCAL VELVENDRON'],
  ['ALEXANDRE HURDOWAR', 'ALEXANDRE ROGER HURDOWAR'],
  ['AVINASH JOGANAH', 'VIGESHWAH NAIDU AVINASH JOGANAH'],
  ['REZA ALIMAMOD NAYAN', 'ALIMAMOD NAYAN REZA'],
  ['MICHAEL BUSSIER', 'MICHAEL BUSSIER MC INTYRE'],
  ['MAHE HARDY', 'MAHE DE BRAGRD HARDY'],
  ['FRANCOIS PIELTAIN', 'PIELTAIN FRANCOIS XAVIER'],
  ['BAPTISTE DESVAUX', 'BAPTISTE DESVAUX DE MARIGNY'],
  ['MAXWELL TERNEL', 'PIERRE YVES MAXWELL TERNEL'],
  ['DARRYL YOUNG', 'RYAN DARRYL NU NAM YOUNG'],
  ['STEPHANE HENRY PAYET', 'PAYET STEPHANE'],
  ['OLIVIER LAURENT PAYET', 'OLIVIER PAYET'],
  ['LEONARDO NOA NAVARRINI', 'LEONARDO NAVARRINI'],
  ['SHANE FONG', 'SHANE FONG YONG'],
  ['YASSIR RABENANTENAINA', 'YASSIR MAMOD RABENANTENAINA'],
  ['CLARA HENRY GOMEZ', 'CLARA GOMEZ HENRY'],
  ['AGNES DESVAUX', 'AGNES DESVAUX DE MARIGNY'],
  ['NICOLE VERMAAK', 'NICOLE MONIQUE VERMAAK'],
  ['DEBORAH ROBERTS', 'DEBORAH ROBERTS ROUSSEL'],
  ['SINDY DE ROBILLARD', 'SKOCZEK DE ROBILLARD SINDY'],
  ['HAVISHA SIMI BUNJUN', 'SIMI BUNJUN'],
  ['ZARAH RAZAFIMAHATRATRA', 'ZARAH NAMBININA RAZAFIMAHATRATRA'],
  ['CORINE PARK', 'CORINE PARK MAZURIER'],
  ['YOANNE LAPORTE', 'YOANNE LAPORTE RAVELONARIVO'],
  ['ANNA BLUE', 'ANNA BLUE HOUAREAU'],
  ['CELINE DESVAUX', 'CELINE DESVAUX DE MARIGNY'],
  ['AMBER LAM', 'AMBER LAM SZE KO'],
